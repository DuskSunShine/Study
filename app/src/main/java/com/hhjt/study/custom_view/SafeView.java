...
public class SafeView extends View {
    ...
    private LinearGradient mLeftLinearGradient;//线性渐变
    ...
    public SafeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.SafeView);
        safeText = typedArray.getString(R.styleable.SafeView_text);
        init();
        typedArray.recycle();
    ...
    private void init() {
        ...
        mPaint.setStrokeCap(Paint.Cap.ROUND);//圆角笔尖
    ...
    private void rotateCanvas(Canvas canvas) {
        ...
        matrix.preTranslate(-matrixCenterX, -matrixCenterY);
        matrix.postTranslate(matrixCenterX, matrixCenterY);
